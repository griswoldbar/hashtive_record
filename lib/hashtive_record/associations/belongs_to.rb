module HashtiveRecord
  module Associations
    ...
    class BelongsTo
      ...
      def initialize(belonger_klass, association_name, options={})
        # described_class.new(Pet, :owner, class_name: :player)
        @belonger_klass = belonger_klass
        @association_name = association_name
        @parent_klass_name = options[:class_name] || association_name
      ...
      def add_to_reflection(options)
        belonger_klass.reflection.add_belongs_to(association_name, options)
      end
